...
export const Deposit: Story = {
  args: {
    actions: (
      <>
        <Button size="sm" variant="outline">거래내역</Button>
        <Button size="sm" variant="primary">이체</Button>
      </>
    ),
  },
};
...
export const WithChevron: Story = {
  args: {
    ...
    actions: (
      <>
        <Button size="sm" variant="primary">이체</Button>
        <Button size="sm" variant="outline">ATM출금</Button>
      </>
    ),
  },
};
