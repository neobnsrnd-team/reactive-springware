...
const CardImagePlaceholder = () => (
  <div className="w-full h-full bg-gradient-to-br from-brand to-brand-dark flex items-end p-md">
    <span className="text-white font-bold text-lg">하나은행</span>
  </div>
);
...
export const Compact: Story = {
  args: { compact: true },
  decorators: [(Story: React.ComponentType) => <div style={{ width: 390, padding: 16, background: '#fff' }}><Story /></div>],
};
