...
export type { SearchFilter, CardOption }  from '../../../overlays/card/UsageHistoryFilterSheet';
...
export interface UsageHistoryPageProps {
  ...
  cardOptions:        import('../../../overlays/card/UsageHistoryFilterSheet').CardOption[];
  onLoadMore?:        () => void;
  onInstallment?:     () => void;
  onImmediatePayment?: () => void;
  onRevolving?:       () => void;
  onSearch?:          (filter: import('../../../overlays/card/UsageHistoryFilterSheet').SearchFilter) => void;
  onBack?:            () => void;
  onClose?:           () => void;
}
